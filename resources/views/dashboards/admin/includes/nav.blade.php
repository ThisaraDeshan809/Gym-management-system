<nav navbar-main class=" flex  bg-transparent flex-wrap items-center justify-between px-0 py-2 mx-6 mt-6 transition-all  duration-250 ease-soft-in rounded-lg lg:flex-nowrap lg:justify-start sticky top-[1%] backdrop-saturate-200 backdrop-blur-2xl z-110 dark:bg-gray-950/80 dark:shadow-dark-blur" navbar-scroll="true">
  <div class="flex items-center justify-between w-full px-4 py-2 mx-auto flex-wrap-inherit">
    <nav>
      ...
      <h6 class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:text-gray-600 dark:text-white dark:before:text-white">
        {{ \Illuminate\Support\Str::limit( $authUser->name, 10, '...') }}
    </h6>
