        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-4/12 lg:mb-0 mb-12 px-4 flex justify-center items-center mt-5" data-aos="flip-right">
                <div class="px-6 text-center">
                    <img alt="..." src="{{ Storage::url('public/assets/images/equipments/' . $equipment->image) }}"
                    class="shadow-lg rounded mx-auto" style="max-width: 250px;" />
                    <div class="pt-6">
                        <h5 class="text-xl font-bold">{{ $equipment->name }}</h5>
                        <label for=""> Quantity Available
                        ...
                        <button type="button" data-toggle="modal" data-target="#equipment_reserve"
                            ...
                            id="btn_reserve_equipment" data-id="{{ $equipment->id }}">Reserve Now</button>
                    </div>
                </div>
            </div>
            @endforeach
